...
func _draw():
	...
	draw_line(character_point, Vector2(character_point.x, dialogue_point.y), Color(1, 1, 1), 2)
	draw_line(Vector2(character_point.x, dialogue_point.y), dialogue_point, Color(1, 1, 1), 2)
